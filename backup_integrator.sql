...
ALTER TABLE IF EXISTS ONLY students.students DROP CONSTRAINT IF EXISTS students_plan_id_fkey;
ALTER TABLE IF EXISTS ONLY students.student_health_data DROP CONSTRAINT IF EXISTS student_health_data_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.registrations DROP CONSTRAINT IF EXISTS registrations_user_id_fkey;
ALTER TABLE IF EXISTS ONLY finance.invoices DROP CONSTRAINT IF EXISTS invoices_student_id_fkey;
ALTER TABLE IF EXISTS ONLY finance.invoices DROP CONSTRAINT IF EXISTS invoices_plan_id_fkey;
ALTER TABLE IF EXISTS ONLY core.welcome_email_logs DROP CONSTRAINT IF EXISTS welcome_email_logs_student_id_fkey;
ALTER TABLE IF EXISTS ONLY core.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.enrollments DROP CONSTRAINT IF EXISTS enrollments_student_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.enrollments DROP CONSTRAINT IF EXISTS enrollments_schedule_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.class_students DROP CONSTRAINT IF EXISTS class_students_student_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.class_students DROP CONSTRAINT IF EXISTS class_students_class_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.class_schedule DROP CONSTRAINT IF EXISTS class_schedule_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.attendance_summary DROP CONSTRAINT IF EXISTS attendance_summary_student_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.attendance DROP CONSTRAINT IF EXISTS attendance_student_id_fkey;
ALTER TABLE IF EXISTS ONLY academy.attendance DROP CONSTRAINT IF EXISTS attendance_schedule_id_fkey;
DROP INDEX IF EXISTS students.ix_students_students_cpf;
DROP INDEX IF EXISTS public.ix_users_username;
DROP INDEX IF EXISTS public.ix_users_email;
ALTER TABLE IF EXISTS ONLY students.students DROP CONSTRAINT IF EXISTS students_pkey;
ALTER TABLE IF EXISTS ONLY students.students DROP CONSTRAINT IF EXISTS students_email_key;
ALTER TABLE IF EXISTS ONLY students.student_health_data DROP CONSTRAINT IF EXISTS student_health_data_pkey;
...
ALTER TABLE IF EXISTS ONLY finance.plans DROP CONSTRAINT IF EXISTS plans_pkey;
ALTER TABLE IF EXISTS ONLY finance.invoices DROP CONSTRAINT IF EXISTS invoices_pkey;
ALTER TABLE IF EXISTS ONLY finance.expenses DROP CONSTRAINT IF EXISTS expenses_pkey;
ALTER TABLE IF EXISTS ONLY core.welcome_email_logs DROP CONSTRAINT IF EXISTS welcome_email_logs_student_id_key;
ALTER TABLE IF EXISTS ONLY core.welcome_email_logs DROP CONSTRAINT IF EXISTS welcome_email_logs_pkey;
ALTER TABLE IF EXISTS ONLY core.settings DROP CONSTRAINT IF EXISTS settings_pkey;
ALTER TABLE IF EXISTS ONLY core.settings DROP CONSTRAINT IF EXISTS settings_key_key;
ALTER TABLE IF EXISTS ONLY core.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY academy.modalities DROP CONSTRAINT IF EXISTS modalities_pkey;
ALTER TABLE IF EXISTS ONLY academy.enrollments DROP CONSTRAINT IF EXISTS enrollments_pkey;
ALTER TABLE IF EXISTS ONLY academy.class_students DROP CONSTRAINT IF EXISTS class_students_pkey;
ALTER TABLE IF EXISTS ONLY academy.class_schedule DROP CONSTRAINT IF EXISTS class_schedule_pkey;
ALTER TABLE IF EXISTS ONLY academy.attendance_summary DROP CONSTRAINT IF EXISTS attendance_summary_pkey;
ALTER TABLE IF EXISTS ONLY academy.attendance DROP CONSTRAINT IF EXISTS attendance_pkey;
ALTER TABLE IF EXISTS ONLY academy.activities DROP CONSTRAINT IF EXISTS activities_pkey;
ALTER TABLE IF EXISTS ONLY academy.activities DROP CONSTRAINT IF EXISTS activities_name_key;
ALTER TABLE IF EXISTS students.students ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS students.student_health_data ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.registrations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS finance.plans ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS finance.invoices ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS finance.expenses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS core.welcome_email_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS core.settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS core.audit_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.modalities ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.enrollments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.class_schedule ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.attendance_summary ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.attendance ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS academy.activities ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS students.students_id_seq;
DROP TABLE IF EXISTS students.students;
DROP SEQUENCE IF EXISTS students.student_health_data_id_seq;
DROP TABLE IF EXISTS students.student_health_data;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.registrations_id_seq;
DROP TABLE IF EXISTS public.registrations;
DROP TABLE IF EXISTS public.alembic_version;
DROP SEQUENCE IF EXISTS finance.plans_id_seq;
DROP TABLE IF EXISTS finance.plans;
DROP SEQUENCE IF EXISTS finance.invoices_id_seq;
DROP TABLE IF EXISTS finance.invoices;
DROP SEQUENCE IF EXISTS finance.expenses_id_seq;
DROP TABLE IF EXISTS finance.expenses;
DROP SEQUENCE IF EXISTS core.welcome_email_logs_id_seq;
DROP TABLE IF EXISTS core.welcome_email_logs;
DROP SEQUENCE IF EXISTS core.settings_id_seq;
DROP TABLE IF EXISTS core.settings;
DROP SEQUENCE IF EXISTS core.audit_logs_id_seq;
DROP TABLE IF EXISTS core.audit_logs;
DROP SEQUENCE IF EXISTS academy.modalities_id_seq;
DROP TABLE IF EXISTS academy.modalities;
DROP SEQUENCE IF EXISTS academy.enrollments_id_seq;
DROP TABLE IF EXISTS academy.enrollments;
DROP TABLE IF EXISTS academy.class_students;
DROP SEQUENCE IF EXISTS academy.class_schedule_id_seq;
DROP TABLE IF EXISTS academy.class_schedule;
DROP SEQUENCE IF EXISTS academy.attendance_summary_id_seq;
DROP TABLE IF EXISTS academy.attendance_summary;
DROP SEQUENCE IF EXISTS academy.attendance_id_seq;
DROP TABLE IF EXISTS academy.attendance;
DROP SEQUENCE IF EXISTS academy.activities_id_seq;
DROP TABLE IF EXISTS academy.activities;
DROP SCHEMA IF EXISTS students;
DROP SCHEMA IF EXISTS finance;
DROP SCHEMA IF EXISTS core;
DROP SCHEMA IF EXISTS academy;
--
-- Name: academy; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: activities; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: activities_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: activities_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: attendance; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: attendance_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: attendance_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: class_students; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: enrollments; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: enrollments_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: enrollments_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: modalities; Type: TABLE; Schema: academy; Owner: -
--
...
--
-- Name: modalities_id_seq; Type: SEQUENCE; Schema: academy; Owner: -
--
...
--
-- Name: modalities_id_seq; Type: SEQUENCE OWNED BY; Schema: academy; Owner: -
--
...
--
-- Name: settings_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--
...
--
-- Name: settings_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs; Type: TABLE; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs_id_seq; Type: SEQUENCE; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: core; Owner: -
--
...
--
-- Name: expenses_id_seq; Type: SEQUENCE; Schema: finance; Owner: -
--
...
--
-- Name: expenses_id_seq; Type: SEQUENCE OWNED BY; Schema: finance; Owner: -
--
...
--
-- Name: invoices_id_seq; Type: SEQUENCE OWNED BY; Schema: finance; Owner: -
--
...
--
-- Name: plans; Type: TABLE; Schema: finance; Owner: -
--
...
--
-- Name: plans_id_seq; Type: SEQUENCE; Schema: finance; Owner: -
--
...
--
-- Name: plans_id_seq; Type: SEQUENCE OWNED BY; Schema: finance; Owner: -
--
...
--
-- Name: student_health_data; Type: TABLE; Schema: students; Owner: -
--
...
--
-- Name: student_health_data_id_seq; Type: SEQUENCE; Schema: students; Owner: -
--
...
--
-- Name: student_health_data_id_seq; Type: SEQUENCE OWNED BY; Schema: students; Owner: -
--
...
--
-- Name: students_id_seq; Type: SEQUENCE; Schema: students; Owner: -
--
...
--
-- Name: students_id_seq; Type: SEQUENCE OWNED BY; Schema: students; Owner: -
--
...
--
-- Name: activities id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: attendance id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: enrollments id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: modalities id; Type: DEFAULT; Schema: academy; Owner: -
--
...
--
-- Name: settings id; Type: DEFAULT; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs id; Type: DEFAULT; Schema: core; Owner: -
--
...
--
-- Name: expenses id; Type: DEFAULT; Schema: finance; Owner: -
--
...
--
-- Name: invoices id; Type: DEFAULT; Schema: finance; Owner: -
--
...
--
-- Name: plans id; Type: DEFAULT; Schema: finance; Owner: -
--
...
--
-- Name: student_health_data id; Type: DEFAULT; Schema: students; Owner: -
--
...
--
-- Name: students id; Type: DEFAULT; Schema: students; Owner: -
--
...
--
-- Data for Name: activities; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: attendance; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: attendance_summary; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: class_schedule; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: class_students; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: enrollments; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: modalities; Type: TABLE DATA; Schema: academy; Owner: -
--
...
--
-- Data for Name: welcome_email_logs; Type: TABLE DATA; Schema: core; Owner: -
--
...
--
-- Data for Name: expenses; Type: TABLE DATA; Schema: finance; Owner: -
--
...
--
-- Data for Name: invoices; Type: TABLE DATA; Schema: finance; Owner: -
--
...
--
-- Data for Name: plans; Type: TABLE DATA; Schema: finance; Owner: -
--
...
--
-- Data for Name: student_health_data; Type: TABLE DATA; Schema: students; Owner: -
--
...
--
-- Name: activities_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: attendance_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: enrollments_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: modalities_id_seq; Type: SEQUENCE SET; Schema: academy; Owner: -
--
...
--
-- Name: audit_logs_id_seq; Type: SEQUENCE SET; Schema: core; Owner: -
--
...
--
-- Name: settings_id_seq; Type: SEQUENCE SET; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs_id_seq; Type: SEQUENCE SET; Schema: core; Owner: -
--
...
--
-- Name: expenses_id_seq; Type: SEQUENCE SET; Schema: finance; Owner: -
--
...
--
-- Name: invoices_id_seq; Type: SEQUENCE SET; Schema: finance; Owner: -
--
...
--
-- Name: plans_id_seq; Type: SEQUENCE SET; Schema: finance; Owner: -
--
...
--
-- Name: student_health_data_id_seq; Type: SEQUENCE SET; Schema: students; Owner: -
--
...
--
-- Name: students_id_seq; Type: SEQUENCE SET; Schema: students; Owner: -
--
...
--
-- Name: activities activities_name_key; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: activities activities_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: attendance attendance_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary attendance_summary_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule class_schedule_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: class_students class_students_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: enrollments enrollments_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: modalities modalities_pkey; Type: CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: settings settings_key_key; Type: CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs welcome_email_logs_pkey; Type: CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs welcome_email_logs_student_id_key; Type: CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: plans plans_pkey; Type: CONSTRAINT; Schema: finance; Owner: -
--
...
--
-- Name: student_health_data student_health_data_pkey; Type: CONSTRAINT; Schema: students; Owner: -
--
...
--
-- Name: students students_email_key; Type: CONSTRAINT; Schema: students; Owner: -
--
...
--
-- Name: ix_students_students_cpf; Type: INDEX; Schema: students; Owner: -
--
...
--
-- Name: attendance attendance_schedule_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: attendance attendance_student_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: attendance_summary attendance_summary_student_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: class_schedule class_schedule_activity_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: class_students class_students_class_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: class_students class_students_student_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: enrollments enrollments_schedule_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: enrollments enrollments_student_id_fkey; Type: FK CONSTRAINT; Schema: academy; Owner: -
--
...
--
-- Name: audit_logs audit_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: welcome_email_logs welcome_email_logs_student_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: -
--
...
--
-- Name: invoices invoices_plan_id_fkey; Type: FK CONSTRAINT; Schema: finance; Owner: -
--
...
--
-- Name: invoices invoices_student_id_fkey; Type: FK CONSTRAINT; Schema: finance; Owner: -
--
...
--
-- Name: student_health_data student_health_data_student_id_fkey; Type: FK CONSTRAINT; Schema: students; Owner: -
--
...
--
-- Name: students students_plan_id_fkey; Type: FK CONSTRAINT; Schema: students; Owner: -
--
