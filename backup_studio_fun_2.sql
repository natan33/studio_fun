...
\restrict odCrjlqtTc92L3WMj03xMBS1jf5ybWK8EToV9cj1oPnGebgeqoTiwDwi39NZtnJ
...
SELECT pg_catalog.setval('academy.activities_id_seq', 9, true);
...
SELECT pg_catalog.setval('academy.class_schedule_id_seq', 45, true);
...
SELECT pg_catalog.setval('academy.enrollments_id_seq', 21, true);
...
SELECT pg_catalog.setval('core.welcome_email_logs_id_seq', 7, true);
...
SELECT pg_catalog.setval('finance.invoices_id_seq', 29, true);
...
SELECT pg_catalog.setval('students.student_health_data_id_seq', 6, true);
...
SELECT pg_catalog.setval('students.students_id_seq', 7, true);
...
\unrestrict odCrjlqtTc92L3WMj03xMBS1jf5ybWK8EToV9cj1oPnGebgeqoTiwDwi39NZtnJ
